...
// Cubes represents an ordered set of coordinates in the cube coordinate system
type Cubes struct {
	*orderedSet[Cube, *Cubes]
}

// NewCubes returns a new ordered set of coordinates with the given initial set of coordinates
